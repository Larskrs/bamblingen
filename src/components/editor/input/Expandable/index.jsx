...
export default function Expandable ({title="Dette feltet kan gjøres større", icon="/icons/article_content.png", children}, props) {

    const [expanded, setExpanded] = useState(false)

    return (
        <div className={styles.c} style={expanded ? { background: "var(--secondary-75)"} : {}}>
            <div draggable={!expanded} onClick={() => {setExpanded(!expanded)}} className={styles.header}>
